...
#define HW_IOT_MQTT_SERVICES_NUM 2   /* 服务上报 json 服务数量 */
#define HW_IOT_MQTT_PROPERTIES_NUM 2 /* 属性上报 json 属性数量 */
...
typedef struct
{
    ...
    char *properties_value[HW_IOT_MQTT_PROPERTIES_NUM]; /* 事件属性值 数组 */
